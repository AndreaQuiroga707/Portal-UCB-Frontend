      ...
      <Modal show={showForm} onHide={handleClose}>
        ...
        <Modal.Body>
          {tipoFormulario === "evento" ? (
            ...
            <FormInstitutoInvestigacion onSubmit={onAgregarInstitutoInvestigacion} onClose={handleClose} />
          ) : tipoFormulario === "SociedadCientifica" ? (
            <FormSociedadCientifica onSubmit={onAgregarSociedadCientifica} onClose={handleClose} />
          ) : tipoFormulario === "CentroInvestigacion" ? (
            <FormCentroInvestigacion onSubmit={onAgregarCentroInvestigacion} onClose={handleClose} />
          ) : (
            <FormResearchGroup onSubmit={onAgregarGrupoInvestigacion} onClose={handleClose} />
          )}
        </Modal.Body>
      </Modal>
    </>
